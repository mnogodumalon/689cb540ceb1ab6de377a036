...
import { FileText, LayoutDashboard, Menu, Settings, Undo2, Users } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Feuerwehr Bereitschaftsmanagement';
...
const navigation = [
  ...
  { name: 'Personalverwaltung', href: '/personalverwaltung', icon: Users },
  { name: 'Bereitschaftsdienst', href: '/bereitschaftsdienst', icon: FileText },
  { name: 'Einsatzprotokoll', href: '/einsatzprotokoll', icon: FileText },
];

const externalNavigation = [
  { name: 'Personalverwaltung', href: '/gateway/apps/689cb529a2bd8ef1df5d53da?template=list_page', icon: Users },
  { name: 'Bereitschaftsdienst', href: '/gateway/apps/689cb52e3211bd59ce8f6461?template=list_page', icon: FileText },
  { name: 'Einsatzprotokoll', href: '/gateway/apps/689cb52fac1e6b256fa808a2?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/689cb529a2bd8ef1df5d53da?template=list_page"
