...
export function PersonalverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: PersonalverwaltungDialogProps) {
